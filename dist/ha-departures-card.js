 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const mt=1,_t=t=>(...e)=>({_$litDirective$:t,values:e});class $t{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const gt="important",yt=" !"+gt,At=_t(class extends $t{constructor(t){if(super(t),t.type!==mt||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((e,i)=>{const s=t[i];return null==s?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`}),"")}update(t,[e]){const{style:i}=t.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(e)),this.render(e);for(const t of this.ft)null==e[t]&&(this.ft.delete(t),t.includes("-")?i.removeProperty(t):i[t]=null);for(const t in e){const s=e[t];if(null!=s){this.ft.add(t);const e="string"==typeof s&&s.endsWith(yt);t.includes("-")||e?i.setProperty(t,e?s.slice(0,-11):s,e?gt:""):i[t]=s}}return B}});var vt;!function(t){t.PLANNED_TIME="planned_departure_time",t.PLANNED_TIME_1="planned_departure_time_1",t.PLANNED_TIME_2="planned_departure_time_2",t.PLANNED_TIME_3="planned_departure_time_3",t.PLANNED_TIME_4="planned_departure_time_4",t.ESTIMATED_TIME="estimated_departure_time",t.ESTIMATED_TIME_1="estimated_departure_time_1",t.ESTIMATED_TIME_2="estimated_departure_time_2",t.ESTIMATED_TIME_3="estimated_departure_time_3",t.ESTIMATED_TIME_4="estimated_departure_time_4",t.LINE_NAME="line_name",t.DIRECTION="direction",t.TRANSPORT="transport",t.LINE_ID="line_id",t.FRIENDLY_NAME="friendly_name",t.ICON="icon"}(vt||(vt={}));
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const bt=_t(class extends $t{constructor(t){if(super(t),t.type!==mt||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const i=t.element.classList;for(const t of this.st)t in e||(i.remove(t),this.st.delete(t));for(const t in e){const s=!!e[t];s===this.st.has(t)||this.nt?.has(t)||(s?(i.add(t),this.st.add(t)):(i.remove(t),this.st.delete(t)))}return B}}),Et=Symbol.for("constructDateFrom");function wt(t,e){return"function"==typeof t?t(e):t&&"object"==typeof t&&Et in t?t[Et](e):t instanceof Date?new t.constructor(e):new Date(e)}function Tt(t,e){return wt(e||t,t)}function St(t){return!(!((e=t)instanceof Date||"object"==typeof e&&"[object Date]"===Object.prototype.toString.call(e))&&"number"!=typeof t||isNaN(+Tt(t)));var e}function xt(t,e,i){const s=(n=e,(+Tt(t)-+Tt(n))/6e4);var n,r;return(r=i?.roundingMethod,t=>{const e=(r?Math[r]:Math.trunc)(t);return 0===e?0:e})(s)}function Mt(t,e){return(t<0?"-":"")+Math.abs(t).toString().padStart(e,"0")}const Nt={y(t,e){const i=t.getFullYear(),s=i>0?i:1-i;return Mt("yy"===e?s%100:s,e.length)},M(t,e){const i=t.getMonth();return"M"===e?String(i+1):Mt(i+1,2)},d:(t,e)=>Mt(t.getDate(),e.length),a(t,e){const i=t.getHours()/12>=1?"pm":"am";switch(e){case"a":case"aa":return i.toUpperCase();case"aaa":return i;case"aaaaa":return i[0];default:return"am"===i?"a.m.":"p.m."}},h:(t,e)=>Mt(t.getHours()%12||12,e.length),H:(t,e)=>Mt(t.getHours(),e.length),m:(t,e)=>Mt(t.getMinutes(),e.length),s:(t,e)=>Mt(t.getSeconds(),e.length),S(t,e){const i=e.length,s=t.getMilliseconds();return Mt(Math.trunc(s*Math.pow(10,i-3)),e.length)}};function It(t,e){const i=Tt(t,e?.in);return i.setSeconds(0,0),i}function Ct(t){return e=t,i=function(t){return wt(t,Date.now())}(t),+It(e)==+It(i);var e,i}const Pt=/(\w)\1*|''|'(''|[^'])+('|$)|./g,Dt=/^'([^]*?)'?$/,Ot=/''/g,Ut=/[a-zA-Z]/;function Ht(t,e){const i=Tt(t);if(!St(i))throw new RangeError("Invalid time value");const s=e.match(Pt);if(!s)return"";return s.map((t=>{if("''"===t)return"'";const e=t[0];if("'"===e)return function(t){const e=t.match(Dt);return e?e[1].replace(Ot,"'"):t}(t);const s=Nt[e];if(s)return s(i,t);if(e.match(Ut))throw new RangeError("Format string contains an unescaped latin alphabet character `"+e+"`");return t})).join("")}var kt;!function(t){t.NONE="none",t.TIMESTAMP="timestamp",t.DIFF="diff",t.NOW="now"}(kt||(kt={}));class Rt{constructor(t){this._mode=kt.NONE,this._realTime=t,this._delay=0,this._time="-",this._prefix="",this._postfix=""}updateTime(t,e=""){switch(this._mode=t,t){case kt.TIMESTAMP:this._prefix="",this._postfix="",this._time=e;break;case kt.DIFF:this._prefix="in",this._postfix="min",this._time=e;break;case kt.NOW:this._prefix="",this._postfix="",this._time="Now";break;case kt.NONE:this._prefix="",this._postfix="",this._time="-";break;default:console.warn("Unknown mode",t)}}set delay(t){this._delay=t}get mode(){return this._mode}get delay(){return this._delay}get realTime(){return this._realTime}get prefix(){return this._prefix}get postfix(){return this._postfix}get time(){return this._time}}function jt(t,e){let i=new Rt(!!e),s=Lt(Date()),n=Lt(t),r=Lt(e);if(!n)return i.updateTime(kt.NONE),i;if(r||(r=n),i.delay=xt(r,n),Ct(r)||+Tt(r)<Date.now())return i.updateTime(kt.NOW),i;const o=r&&s?xt(r,s):0;return o>=60?i.updateTime(kt.TIMESTAMP,Ht(r,"HH:mm")):i.updateTime(kt.DIFF,o.toString()),i}function Lt(t){if(!t||"unknown"===t)return null;let e=new Date(t);return e.setSeconds(0,0),e}let zt=class extends rt{constructor(){super(...arguments),this.planned=null,this.estimated=null,this.showAnimation=!0,this.data=new Rt(!1),this.INTERVAL=1e4,this.updateTime=()=>{this.data=jt(this.planned,this.estimated)}}connectedCallback(){super.connectedCallback(),this.intervalTimer=setInterval(this.updateTime,this.INTERVAL),this.updateTime()}disconnectedCallback(){super.disconnectedCallback(),clearInterval(this.intervalTimer),this.intervalTimer=void 0}getTimeHtml(){let t;let e=!1;switch(this.data.mode){case kt.NOW:t=F`<ha-icon icon=${"mdi:bus-side"}></ha-icon>`,e=this.showAnimation&&!0;break;case kt.DIFF:let i=Number(this.data.time);i>=0&&i<=5&&(e=this.showAnimation&&!0);case kt.TIMESTAMP:case kt.NONE:t=F`${this.data.time}`}return F`
            <div class="text ${bt({pulsating:e})}">${t}</div>
        `}getDelayHtml(){let t;this.data.realTime&&this.data.mode==kt.DIFF&&(t=this.data.delay>=0?`+${this.data.delay}`:`${this.data.delay}`);const e={green:this.data.delay<=0,red:this.data.delay>0};return F`<div class="delay ${bt(e)}">${t}</div>`}render(){return F`
            <div class="container">
    ...
    `],t([ct({attribute:!1})],zt.prototype,"planned",void 0),t([ct({attribute:!1})],zt.prototype,"estimated",void 0),t([ct({attribute:!1})],zt.prototype,"showAnimation",void 0),t([dt()],zt.prototype,"data",void 0),zt=t([at("departure-text")],zt);let Ft=class extends rt{constructor(){super(...arguments),this.showIcon=!1,this.lineColor="",this.timesToShow=1,this.showAnimation=!0,this.times=[]}updateTimes(){this.times=[],this.times.push([this.state?.attributes[vt.PLANNED_TIME],this.state?.attributes[vt.ESTIMATED_TIME]]),this.times.push([this.state?.attributes[vt.PLANNED_TIME_1],this.state?.attributes[vt.ESTIMATED_TIME_1]]),this.times.push([this.state?.attributes[vt.PLANNED_TIME_2],this.state?.attributes[vt.ESTIMATED_TIME_2]]),this.times.push([this.state?.attributes[vt.PLANNED_TIME_3],this.state?.attributes[vt.ESTIMATED_TIME_3]]),this.times.push([this.state?.attributes[vt.PLANNED_TIME_4],this.state?.attributes[vt.ESTIMATED_TIME_4]])}render(){return this.updateTimes(),F`
        ...
        `}renderIcon(){if(!this.showIcon)return W;let t=this.state.attributes[vt.ICON]??"mdi:train-bus";return F`
            <div class="cell-icon">
    ...
    `}};Bt.styles=pt,t([ct({attribute:!1})],Bt.prototype,"hass",void 0),t([dt()],Bt.prototype,"config",void 0),t([dt()],Bt.prototype,"_open",void 0),Bt=t([at("departures-card")],Bt);export{Bt as DeparturesCard};
