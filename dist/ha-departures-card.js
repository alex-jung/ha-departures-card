 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */}function dt(t){return lt({...t,state:!0,attribute:!1})}const pt=o`
    ha-card {
        display: block;
        height: auto;
        width: 100%;
    ...
    `;const ut={en:{card:{editor:{title:"Card titel (optional)",icon:"Card icon (optional)",showAnimation:"Show arrival animation",showTransportIcon:"Show transport icon",hideEmptyDepartures:"Hide empty departures",debug:"Debug",departuresToShow:"Departures to show",addEntity:"Add entity",entity:{entity:"Entity",destinationName:"Destination name",lineName:"Line name",lineColor:"Line color",nowIcon:"Now icon",timeStyle:"Departure time style",remove:"Delete"}},departures:"Departures",line:"Line",destination:"Destination"}},de:{card:{editor:{title:"Card Titel (optional)",icon:"Card Icon (optional)",showAnimation:"Animation anzeigen",showTransportIcon:"Transport Icon anzeigen",hideEmptyDepartures:"Leere Abfahrten ausblenden",debug:"Debug",departuresToShow:"Anzahl der Abfahrten",addEntity:"Neue Entity",entity:{entity:"Entity",destinationName:"Zielname",lineName:"Linienname",lineColor:"Linienfarbe",nowIcon:"Anfahrt Icon",timeStyle:"Ankunftszeit Stil",remove:"Entfernen"}},departures:"Abfahrten",line:"Linie",destination:"Ziel"}}};function mt(t,e){return e.split(".").reduce(((t,e)=>t?.[e]),t)}function ft(t,e="en",i){const s=Object.keys(ut).includes(e)?e:"en",n=ut.en;let r=mt(ut[s],t)??mt(n,t);if("string"!=typeof r)return t;if(i)for(const[t,e]of Object.entries(i))r=r.replace(new RegExp(`{${t}}`,"g"),e);return r}let gt=class extends rt{constructor(){super(...arguments),this.moreInfo=!1}getState(t){return this.hass?this.hass.states[t]:{}}render(){this.hass.locale;const t=void 0===this.config.showAnimation||this.config.showAnimation,e=void 0!==this.config.showTransportIcon&&this.config.showTransportIcon,i=void 0!==this.config.hideEmptyDepartures&&this.config.hideEmptyDepartures;let s=void 0===this.config.departuresToShow?1:this.config.departuresToShow;return this.moreInfo&&(s=5),F`
            ...
            <hr style="width:100%"/>
            ${this.config.entities?this.config.entities.map((n=>F`
                <departures-row 
                    .config=${n}
                    .hass=${this.hass} 
                    .showIcon=${e}
                    .debug=${!0===this.config.debug}
                    .state=${this.getState(n.entity)}
                    .timesToShow=${s}
                    .showAnimation=${t}
...
const wt=yt(class extends bt{constructor(t){if(super(t),t.type!==_t||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const i=t.element.classList;for(const t of this.st)t in e||(i.remove(t),this.st.delete(t));for(const t in e){const s=!!e[t];s===this.st.has(t)||this.nt?.has(t)||(s?(i.add(t),this.st.add(t)):(i.remove(t),this.st.delete(t)))}return V}});function xt(t){if(!t||"unknown"===t)return null;let e=new Date(t);return e.setSeconds(0,0),e}const Tt=Symbol.for("constructDateFrom");function St(t,e){return"function"==typeof t?t(e):t&&"object"==typeof t&&Tt in t?t[Tt](e):t instanceof Date?new t.constructor(e):new Date(e)}function It(t,e){return St(e||t,t)}function Mt(t){return!(!((e=t)instanceof Date||"object"==typeof e&&"[object Date]"===Object.prototype.toString.call(e))&&"number"!=typeof t||isNaN(+It(t)));var e}function Nt(t,e,i){const s=(n=e,(+It(t)-+It(n))/6e4);var n,r;return(r=i?.roundingMethod,t=>{const e=(r?Math[r]:Math.trunc)(t);return 0===e?0:e})(s)}function Ct(t,e){return(t<0?"-":"")+Math.abs(t).toString().padStart(e,"0")}const Dt={y(t,e){const i=t.getFullYear(),s=i>0?i:1-i;return Ct("yy"===e?s%100:s,e.length)},M(t,e){const i=t.getMonth();return"M"===e?String(i+1):Ct(i+1,2)},d:(t,e)=>Ct(t.getDate(),e.length),a(t,e){const i=t.getHours()/12>=1?"pm":"am";switch(e){case"a":case"aa":return i.toUpperCase();case"aaa":return i;case"aaaaa":return i[0];default:return"am"===i?"a.m.":"p.m."}},h:(t,e)=>Ct(t.getHours()%12||12,e.length),H:(t,e)=>Ct(t.getHours(),e.length),m:(t,e)=>Ct(t.getMinutes(),e.length),s:(t,e)=>Ct(t.getSeconds(),e.length),S(t,e){const i=e.length,s=t.getMilliseconds();return Ct(Math.trunc(s*Math.pow(10,i-3)),e.length)}};function Pt(t,e){const i=It(t,e?.in);return i.setSeconds(0,0),i}function Ot(t){return e=t,i=function(t){return St(t,Date.now())}(t),+Pt(e)==+Pt(i);var e,i}const Ht=/(\w)\1*|''|'(''|[^'])+('|$)|./g,Lt=/^'([^]*?)'?$/,kt=/''/g,Ut=/[a-zA-Z]/;function jt(t,e){const i=It(t);if(!Mt(i))throw new RangeError("Invalid time value");const s=e.match(Ht);if(!s)return"";return s.map((t=>{if("''"===t)return"'";const e=t[0];if("'"===e)return function(t){const e=t.match(Lt);return e?e[1].replace(kt,"'"):t}(t);const s=Dt[e];if(s)return s(i,t);if(e.match(Ut))throw new RangeError("Format string contains an unescaped latin alphabet character `"+e+"`");return t})).join("")}var Rt;!function(t){t.NONE="none",t.TIMESTAMP="timestamp",t.DIFF="diff",t.NOW="now",t.PAST="past"}(Rt||(Rt={}));class zt{constructor(t){this._delay=0,this._realTime=!1,this._prefix="",this._postfix="",this._time="",this._mode=Rt.NONE,this._styleMode="dynamic",this._styleMode="timestamp"==t?"timestamp":"dynamic"}updateTime(t,e){this._realTime=!!e;let i=xt(Date()),s=xt(t),n=xt(e);if(!s)return void this._updateMode(Rt.NONE);if(n||(n=s),this.delay=Nt(n,s),Ot(n))return void this._updateMode(Rt.NOW);if(+It(n)<Date.now())return void this._updateMode(Rt.PAST);const r=n&&i?Nt(n,i):0;"dynamic"==this._styleMode?r>=60?this._updateMode(Rt.TIMESTAMP,jt(n,"HH:mm")):this._updateMode(Rt.DIFF,r.toString()):this._updateMode(Rt.TIMESTAMP,jt(n,"HH:mm"))}_updateMode(t,e=""){switch(this._mode=t,t){case Rt.TIMESTAMP:this._prefix="",this._postfix="",this._time=e;break;case Rt.DIFF:this._prefix="in",this._postfix="min",this._time=e;break;case Rt.NOW:this._prefix="",this._postfix="",this._time="Now";break;case Rt.NONE:this._prefix="",this._postfix="",this._time="-";break;case Rt.PAST:this._prefix="",this._postfix="",this._time="...";break;default:console.warn("Unknown mode",t)}}set delay(t){this._delay=t}get mode(){return this._mode}get delay(){return this._delay}get realTime(){return this._realTime}get prefix(){return this._prefix}get postfix(){return this._postfix}get time(){return this._time}}class Ft{constructor(t,e){this.index=t,this.config=void 0===e?{entity:"",lineColor:null,lineName:null,timeStyle:"dynamic",destinationName:null,nowIcon:null}:e}}let Vt=class extends rt{constructor(){super(...arguments),this.showAnimation=!0,this.nowIcon="mdi:train-bus"}getTimeHtml(){let t,e=!1;if(!this.time)return F`<div class="text">-</div>`;switch(this.time.mode){case Rt.NOW:t=F`<ha-icon icon=${this.nowIcon}></ha-icon>`,e=this.showAnimation&&!0;break;case Rt.DIFF:let i=Number(this.time.time);i>=0&&i<=5&&(e=this.showAnimation&&!0);case Rt.TIMESTAMP:case Rt.NONE:case Rt.PAST:t=F`${this.time.time}`}return F`
    ...
    `],t([lt({attribute:!1})],Vt.prototype,"time",void 0),t([lt({attribute:!1})],Vt.prototype,"showAnimation",void 0),t([lt({attribute:!1})],Vt.prototype,"nowIcon",void 0),Vt=t([at("departure-text")],Vt);let Wt=class extends rt{constructor(){super(...arguments),this.showIcon=!1,this.debug=!1,this.timesToShow=1,this.showAnimation=!0,this.hideEmptyDepartures=!1,this.times=[],this.INTERVAL=1e4}connectedCallback(){super.connectedCallback(),this.intervalId=window.setInterval((()=>{this._updateTimes()}),this.INTERVAL),this._updateTimes()}disconnectedCallback(){super.disconnectedCallback(),void 0!==this.intervalId&&clearInterval(this.intervalId)}_updateTimes(){let t=this.config?.timeStyle??"dynamic";this.times=[new zt(t),new zt(t),new zt(t),new zt(t),new zt(t)],this.times[0].updateTime(this.state?.attributes[At.PLANNED_TIME],this.state?.attributes[At.ESTIMATED_TIME]),this.times[1].updateTime(this.state?.attributes[At.PLANNED_TIME_1],this.state?.attributes[At.ESTIMATED_TIME_1]),this.times[2].updateTime(this.state?.attributes[At.PLANNED_TIME_2],this.state?.attributes[At.ESTIMATED_TIME_2]),this.times[3].updateTime(this.state?.attributes[At.PLANNED_TIME_3],this.state?.attributes[At.ESTIMATED_TIME_3]),this.times[4].updateTime(this.state?.attributes[At.PLANNED_TIME_4],this.state?.attributes[At.ESTIMATED_TIME_4])}_getNowIcon(){return this.config?.nowIcon?this.config.nowIcon:this.state?.attributes[At.ICON]?this.state.attributes[At.ICON]:"mdi:train-bus"}render(){const t=this.config?.timeStyle??"dynamic",e=[{p:At.PLANNED_TIME,e:At.ESTIMATED_TIME},{p:At.PLANNED_TIME_1,e:At.ESTIMATED_TIME_1},{p:At.PLANNED_TIME_2,e:At.ESTIMATED_TIME_2},{p:At.PLANNED_TIME_3,e:At.ESTIMATED_TIME_3},{p:At.PLANNED_TIME_4,e:At.ESTIMATED_TIME_4}],i=Math.max(0,this.timesToShow||0),s=[];for(const n of e){if(s.length>=i)break;const e=new zt(t),r=this.state?.attributes?.[n.p],o=this.state?.attributes?.[n.e];e.updateTime(r,o),e.mode!==Rt.PAST&&e.mode!==Rt.NONE&&"-"!==e.time&&s.push(e)}const n=Math.max(0,i-s.length),r=n>0?s.concat(new Array(n).fill(null)):s;return!0===this.hideEmptyDepartures&&0===s.length?W:F`
        ...
        `}renderLine(){const t=this.config?.lineName??this.state?.attributes[At.LINE_NAME],e={background:this.config?.lineColor||""};return F`
            <div class="cell-line">
                <div class="line-number" style=${Et(e)}>${t}</div>
            </div>
    ...
    `):W}getTabData(){const t=parseInt(this._currTab)-1;if(t>=0&&t<this._tabs.length)return this._tabs[t]}addEntity(){if(!this._config)return;let t=new Ft(this._tabs.length+1,void 0);this._tabs=[...this._tabs,t],this._currTab=`${this._tabs.length}`,this.updateConfig()}removeEntity(t){if(!this._config)return;const e=parseInt(this._currTab)-1;this._tabs.splice(e,1),this.updateConfig(),this._currTab=Math.max(1,e).toString()}updateEntity(t){t.stopPropagation();let e=this.getTabData();e?(e.config=t.detail,this.updateConfig(),he(this,"config-changed",{config:this._config})):console.warn("No tab found for config change",this._tabs,this._currTab)}updateConfig(){const t={...this._config};t.entities=this._tabs.map((t=>t.config)),this._config=t,he(this,"config-changed",{config:this._config})}handleTabChanged(t){const e=t.detail.name.toString();e!==this._currTab&&(this._currTab=e)}configChanged(t){t.stopPropagation(),this._config&&this.hass&&(this._config=t.detail.value,he(this,"config-changed",{config:this._config}))}};le.styles=[pt,o`
      .entity-editor-content{
          border: 1px solid var(--divider-color);
          padding: 10px;
      }
  ...
  `],t([lt({attribute:!1})],le.prototype,"hass",void 0),t([dt()],le.prototype,"_config",void 0),t([dt()],le.prototype,"_tabs",void 0),t([dt()],le.prototype,"_currTab",void 0),le=t([at("departures-card-editor")],le),window.customCards=window.customCards||[],window.customCards.push({type:"departures-card",name:"Departures Card",description:"Display departure times for different public transports"});console.groupCollapsed("%cDepartures-Card 2.1.0","color:black; font-weight: bold; background: tomato; padding: 2px; border-radius: 5px;"),console.log("Github repository: https://github.com/alex-jung/ha-departures-card"),console.groupEnd();let de=class extends rt{constructor(){super(...arguments),this.moreInfoOpen=!1}static getStubConfig(t){return{type:"custom:departures-card",title:ft("card.departures",t.locale?.language)||"Departures",entity:[]}}static getConfigElement(){return document.createElement("departures-card-editor")}async getCardSize(){return this.config&&this.config.entities?this.config.entities.length+1:1}setConfig(t){if(!t)throw new Error("Invalid configuration");if(this.config=t,!this.config.entities||this.config.entities.length<=0)throw new Error("Please define at least one entity in the configuration.")}render(){const t=this.config.title||ft("card.departures",this.hass.locale?.language),e=this.config.icon||"mdi:bus";return F`
    ...
    `}};de.styles=pt,t([lt({attribute:!1})],de.prototype,"hass",void 0),t([dt()],de.prototype,"config",void 0),t([dt()],de.prototype,"moreInfoOpen",void 0),de=t([at("departures-card")],de);export{de as DeparturesCard};
