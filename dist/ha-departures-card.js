 ...
 */}function dt(t){return lt({...t,state:!0,attribute:!1})}const pt=o`
    ...
    `],t([lt({attribute:!1})],ft.prototype,"hass",void 0),t([lt({attribute:!1})],ft.prototype,"config",void 0),t([lt({attribute:!1})],ft.prototype,"moreInfo",void 0),ft=t([at("departures-table")],ft);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const $t="important",yt=" !"+$t,bt=_t(class extends gt{constructor(t){if(super(t),t.type!==mt||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((e,i)=>{const s=t[i];return null==s?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`}),"")}update(t,[e]){const{style:i}=t.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(e)),this.render(e);for(const t of this.ft)null==e[t]&&(this.ft.delete(t),t.includes("-")?i.removeProperty(t):i[t]=null);for(const t in e){const s=e[t];if(null!=s){this.ft.add(t);const e="string"==typeof s&&s.endsWith(yt);t.includes("-")||e?i.setProperty(t,e?s.slice(0,-11):s,e?$t:""):i[t]=s}}return W}});var At;!function(t){t.PLANNED_TIME="planned_departure_time",t.PLANNED_TIME_1="planned_departure_time_1",t.PLANNED_TIME_2="planned_departure_time_2",t.PLANNED_TIME_3="planned_departure_time_3",t.PLANNED_TIME_4="planned_departure_time_4",t.ESTIMATED_TIME="estimated_departure_time",t.ESTIMATED_TIME_1="estimated_departure_time_1",t.ESTIMATED_TIME_2="estimated_departure_time_2",t.ESTIMATED_TIME_3="estimated_departure_time_3",t.ESTIMATED_TIME_4="estimated_departure_time_4",t.LINE_NAME="line_name",t.DIRECTION="direction",t.TRANSPORT="transport",t.LINE_ID="line_id",t.FRIENDLY_NAME="friendly_name",t.ICON="icon"}(At||(At={}));
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const vt=_t(class extends gt{constructor(t){if(super(t),t.type!==mt||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const i=t.element.classList;for(const t of this.st)t in e||(i.remove(t),this.st.delete(t));for(const t in e){const s=!!e[t];s===this.st.has(t)||this.nt?.has(t)||(s?(i.add(t),this.st.add(t)):(i.remove(t),this.st.delete(t)))}return W}});function wt(t){if(!t||"unknown"===t)return null;let e=new Date(t);return e.setSeconds(0,0),e}const Et=Symbol.for("constructDateFrom");function xt(t,e){return"function"==typeof t?t(e):t&&"object"==typeof t&&Et in t?t[Et](e):t instanceof Date?new t.constructor(e):new Date(e)}function St(t,e){return xt(e||t,t)}function Tt(t){return!(!((e=t)instanceof Date||"object"==typeof e&&"[object Date]"===Object.prototype.toString.call(e))&&"number"!=typeof t||isNaN(+St(t)));var e}function It(t,e,i){const s=(n=e,(+St(t)-+St(n))/6e4);var n,r;return(r=i?.roundingMethod,t=>{const e=(r?Math[r]:Math.trunc)(t);return 0===e?0:e})(s)}function Mt(t,e){return(t<0?"-":"")+Math.abs(t).toString().padStart(e,"0")}const Nt={y(t,e){const i=t.getFullYear(),s=i>0?i:1-i;return Mt("yy"===e?s%100:s,e.length)},M(t,e){const i=t.getMonth();return"M"===e?String(i+1):Mt(i+1,2)},d:(t,e)=>Mt(t.getDate(),e.length),a(t,e){const i=t.getHours()/12>=1?"pm":"am";switch(e){case"a":case"aa":return i.toUpperCase();case"aaa":return i;case"aaaaa":return i[0];default:return"am"===i?"a.m.":"p.m."}},h:(t,e)=>Mt(t.getHours()%12||12,e.length),H:(t,e)=>Mt(t.getHours(),e.length),m:(t,e)=>Mt(t.getMinutes(),e.length),s:(t,e)=>Mt(t.getSeconds(),e.length),S(t,e){const i=e.length,s=t.getMilliseconds();return Mt(Math.trunc(s*Math.pow(10,i-3)),e.length)}};function Pt(t,e){const i=St(t,e?.in);return i.setSeconds(0,0),i}function Ct(t){return e=t,i=function(t){return xt(t,Date.now())}(t),+Pt(e)==+Pt(i);var e,i}const Ot=/(\w)\1*|''|'(''|[^'])+('|$)|./g,Dt=/^'([^]*?)'?$/,Ut=/''/g,Ht=/[a-zA-Z]/;function kt(t,e){const i=St(t);if(!Tt(i))throw new RangeError("Invalid time value");const s=e.match(Ot);if(!s)return"";return s.map((t=>{if("''"===t)return"'";const e=t[0];if("'"===e)return function(t){const e=t.match(Dt);return e?e[1].replace(Ut,"'"):t}(t);const s=Nt[e];if(s)return s(i,t);if(e.match(Ht))throw new RangeError("Format string contains an unescaped latin alphabet character `"+e+"`");return t})).join("")}var jt;!function(t){t.NONE="none",t.TIMESTAMP="timestamp",t.DIFF="diff",t.NOW="now",t.PAST="past"}(jt||(jt={}));class Rt{constructor(t){this._delay=0,this._realTime=!1,this._prefix="",this._postfix="",this._time="",this._mode=jt.NONE,this._styleMode="dynamic",this._styleMode="timestamp"==t?"timestamp":"dynamic"}updateTime(t,e){this._realTime=!!e;let i=wt(Date()),s=wt(t),n=wt(e);if(!s)return void this._updateMode(jt.NONE);if(n||(n=s),this.delay=It(n,s),Ct(n))return void this._updateMode(jt.NOW);if(+St(n)<Date.now())return void this._updateMode(jt.PAST);const r=n&&i?It(n,i):0;"dynamic"==this._styleMode?r>=60?this._updateMode(jt.TIMESTAMP,kt(n,"HH:mm")):this._updateMode(jt.DIFF,r.toString()):this._updateMode(jt.TIMESTAMP,kt(n,"HH:mm"))}_updateMode(t,e=""){switch(this._mode=t,t){case jt.TIMESTAMP:this._prefix="",this._postfix="",this._time=e;break;case jt.DIFF:this._prefix="in",this._postfix="min",this._time=e;break;case jt.NOW:this._prefix="",this._postfix="",this._time="Now";break;case jt.NONE:this._prefix="",this._postfix="",this._time="-";break;case jt.PAST:this._prefix="",this._postfix="",this._time="...";break;default:console.warn("Unknown mode",t)}}set delay(t){this._delay=t}get mode(){return this._mode}get delay(){return this._delay}get realTime(){return this._realTime}get prefix(){return this._prefix}get postfix(){return this._postfix}get time(){return this._time}}let Lt=class extends rt{constructor(){super(...arguments),this.showAnimation=!0,this.nowIcon="mdi:train-bus"}getTimeHtml(){let t,e=!1;if(!this.time)return F`<div class="text">-</div>`;switch(this.time.mode){case jt.NOW:t=F`<ha-icon icon=${this.nowIcon}></ha-icon>`,e=this.showAnimation&&!0;break;case jt.DIFF:let i=Number(this.time.time);i>=0&&i<=5&&(e=this.showAnimation&&!0);case jt.TIMESTAMP:case jt.NONE:case jt.PAST:t=F`${this.time.time}`}return F`
            <div class="text ${vt({pulsating:e})}">${t}</div>
        `}getDelayHtml(){let t;if(!this.time)return F`<div class="delay"></div>`;this.time.realTime&&this.time.mode==jt.DIFF&&(t=this.time.delay>=0?`+${this.time.delay}`:`${this.time.delay}`);const e={green:this.time.delay<=0,red:this.time.delay>0};return F`<div class="delay ${vt(e)}">${t}</div>`}getPostfixHtml(){return this.time?F`
    ...
    `],t([lt({attribute:!1})],Lt.prototype,"time",void 0),t([lt({attribute:!1})],Lt.prototype,"showAnimation",void 0),t([lt({attribute:!1})],Lt.prototype,"nowIcon",void 0),Lt=t([at("departure-text")],Lt);let zt=class extends rt{constructor(){super(...arguments),this.showIcon=!1,this.debug=!1,this.timesToShow=1,this.showAnimation=!0,this.times=[],this.INTERVAL=1e4}connectedCallback(){super.connectedCallback(),this.intervalId=window.setInterval((()=>{this._updateTimes()}),this.INTERVAL),this._updateTimes()}disconnectedCallback(){super.disconnectedCallback(),void 0!==this.intervalId&&clearInterval(this.intervalId)}_updateTimes(){let t=this.config?.timeStyle??"dynamic";this.times=[new Rt(t),new Rt(t),new Rt(t),new Rt(t),new Rt(t)],this.times[0].updateTime(this.state?.attributes[At.PLANNED_TIME],this.state?.attributes[At.ESTIMATED_TIME]),this.times[1].updateTime(this.state?.attributes[At.PLANNED_TIME_1],this.state?.attributes[At.ESTIMATED_TIME_1]),this.times[2].updateTime(this.state?.attributes[At.PLANNED_TIME_2],this.state?.attributes[At.ESTIMATED_TIME_2]),this.times[3].updateTime(this.state?.attributes[At.PLANNED_TIME_3],this.state?.attributes[At.ESTIMATED_TIME_3]),this.times[4].updateTime(this.state?.attributes[At.PLANNED_TIME_4],this.state?.attributes[At.ESTIMATED_TIME_4])}_getNowIcon(){return this.config?.nowIcon?this.config.nowIcon:this.state?.attributes[At.ICON]?this.state.attributes[At.ICON]:"mdi:train-bus"}render(){return F`
            ...
            ${this.debug?this.renderDebugInfo():B}
        ...
        `}renderLine(){const t=this.config?.lineName??this.state?.attributes[At.LINE_NAME],e={background:this.config?.lineColor||""};return F`
            <div class="cell-line">
                <div class="line-number" style=${bt(e)}>${t}</div>
            </div>
        ...
        `}renderDepartureTimes(){let t=this.times.filter((t=>t.mode!=jt.PAST));const e=this.timesToShow-t.length;t=e<=0?t.slice(0,this.timesToShow):t.concat(new Array(e).fill(null));let i=this._getNowIcon();return F`
            ${t.map((t=>F`
                <departure-text 
                    .time=${t} 
    ...
    `}};Ft.styles=pt,t([lt({attribute:!1})],Ft.prototype,"hass",void 0),t([dt()],Ft.prototype,"config",void 0),t([dt()],Ft.prototype,"moreInfoOpen",void 0),Ft=t([at("departures-card")],Ft);export{Ft as DeparturesCard};
