...
const bt=_t(class extends gt{constructor(t){if(super(t),t.type!==ft||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const i=t.element.classList;for(const t of this.st)t in e||(i.remove(t),this.st.delete(t));for(const t in e){const s=!!e[t];s===this.st.has(t)||this.nt?.has(t)||(s?(i.add(t),this.st.add(t)):(i.remove(t),this.st.delete(t)))}return W}});function wt(t){if(!t||"unknown"===t)return null;let e=new Date(t);return e.setSeconds(0,0),e}const Et=Symbol.for("constructDateFrom");function xt(t,e){return"function"==typeof t?t(e):t&&"object"==typeof t&&Et in t?t[Et](e):t instanceof Date?new t.constructor(e):new Date(e)}function St(t,e){return xt(e||t,t)}function Tt(t){return!(!((e=t)instanceof Date||"object"==typeof e&&"[object Date]"===Object.prototype.toString.call(e))&&"number"!=typeof t||isNaN(+St(t)));var e}function Mt(t,e,i){const s=(n=e,(+St(t)-+St(n))/6e4);var n,r;return(r=i?.roundingMethod,t=>{const e=(r?Math[r]:Math.trunc)(t);return 0===e?0:e})(s)}function It(t,e){return(t<0?"-":"")+Math.abs(t).toString().padStart(e,"0")}const Nt={y(t,e){const i=t.getFullYear(),s=i>0?i:1-i;return It("yy"===e?s%100:s,e.length)},M(t,e){const i=t.getMonth();return"M"===e?String(i+1):It(i+1,2)},d:(t,e)=>It(t.getDate(),e.length),a(t,e){const i=t.getHours()/12>=1?"pm":"am";switch(e){case"a":case"aa":return i.toUpperCase();case"aaa":return i;case"aaaaa":return i[0];default:return"am"===i?"a.m.":"p.m."}},h:(t,e)=>It(t.getHours()%12||12,e.length),H:(t,e)=>It(t.getHours(),e.length),m:(t,e)=>It(t.getMinutes(),e.length),s:(t,e)=>It(t.getSeconds(),e.length),S(t,e){const i=e.length,s=t.getMilliseconds();return It(Math.trunc(s*Math.pow(10,i-3)),e.length)}};function Pt(t,e){const i=St(t,e?.in);return i.setSeconds(0,0),i}function Ct(t){return e=t,i=function(t){return xt(t,Date.now())}(t),+Pt(e)==+Pt(i);var e,i}const Dt=/(\w)\1*|''|'(''|[^'])+('|$)|./g,Ot=/^'([^]*?)'?$/,Ut=/''/g,Ht=/[a-zA-Z]/;function kt(t,e){const i=St(t);if(!Tt(i))throw new RangeError("Invalid time value");const s=e.match(Dt);if(!s)return"";return s.map((t=>{if("''"===t)return"'";const e=t[0];if("'"===e)return function(t){const e=t.match(Ot);return e?e[1].replace(Ut,"'"):t}(t);const s=Nt[e];if(s)return s(i,t);if(e.match(Ht))throw new RangeError("Format string contains an unescaped latin alphabet character `"+e+"`");return t})).join("")}var jt;!function(t){t.NONE="none",t.TIMESTAMP="timestamp",t.DIFF="diff",t.NOW="now",t.PAST="past"}(jt||(jt={}));class Rt{constructor(t){this._delay=0,this._realTime=!1,this._prefix="",this._postfix="",this._time="",this._mode=jt.NONE,this._styleMode="dynamic",this._styleMode="timestamp"==t?"timestamp":"dynamic"}updateTime(t,e){this._realTime=!!e;let i=wt(Date()),s=wt(t),n=wt(e);if(!s)return void this._updateMode(jt.NONE);if(n||(n=s),this.delay=Mt(n,s),Ct(n))return void this._updateMode(jt.NOW);if(+St(n)<Date.now())return void this._updateMode(jt.PAST);const r=n&&i?Mt(n,i):0;"dynamic"==this._styleMode?r>=60?this._updateMode(jt.TIMESTAMP,kt(n,"HH:mm")):this._updateMode(jt.DIFF,r.toString()):this._updateMode(jt.TIMESTAMP,kt(n,"HH:mm"))}_updateMode(t,e=""){switch(this._mode=t,t){case jt.TIMESTAMP:this._prefix="",this._postfix="",this._time=e;break;case jt.DIFF:this._prefix="in",this._postfix="min",this._time=e;break;case jt.NOW:this._prefix="",this._postfix="",this._time="Now";break;case jt.NONE:this._prefix="",this._postfix="",this._time="-";break;case jt.PAST:this._prefix="",this._postfix="",this._time="...";break;default:console.warn("Unknown mode",t)}}set delay(t){this._delay=t}get mode(){return this._mode}get delay(){return this._delay}get realTime(){return this._realTime}get prefix(){return this._prefix}get postfix(){return this._postfix}get time(){return this._time}}let Lt=class extends rt{constructor(){super(...arguments),this.showAnimation=!0}getTimeHtml(){let t;let e=!1;if(!this.time)return F`<div class="text">-</div>`;switch(this.time.mode){case jt.NOW:t=F`<ha-icon icon=${"mdi:bus-side"}></ha-icon>`,e=this.showAnimation&&!0;break;case jt.DIFF:let i=Number(this.time.time);i>=0&&i<=5&&(e=this.showAnimation&&!0);case jt.TIMESTAMP:case jt.NONE:case jt.PAST:t=F`${this.time.time}`}return F`
    ...
    `],t([ct({attribute:!1})],Lt.prototype,"time",void 0),t([ct({attribute:!1})],Lt.prototype,"showAnimation",void 0),Lt=t([at("departure-text")],Lt);let zt=class extends rt{constructor(){super(...arguments),this.showIcon=!1,this.timeStyle="dynamic",this.lineColor="",this.timesToShow=1,this.showAnimation=!0,this.times=[],this.INTERVAL=1e4}connectedCallback(){super.connectedCallback(),this.intervalId=window.setInterval((()=>{this._updateTimes()}),this.INTERVAL),this._updateTimes()}disconnectedCallback(){super.disconnectedCallback(),void 0!==this.intervalId&&clearInterval(this.intervalId)}_updateTimes(){this.times=[new Rt(this.timeStyle),new Rt(this.timeStyle),new Rt(this.timeStyle),new Rt(this.timeStyle),new Rt(this.timeStyle)],this.times[0].updateTime(this.state?.attributes[vt.PLANNED_TIME],this.state?.attributes[vt.ESTIMATED_TIME]),this.times[1].updateTime(this.state?.attributes[vt.PLANNED_TIME_1],this.state?.attributes[vt.ESTIMATED_TIME_1]),this.times[2].updateTime(this.state?.attributes[vt.PLANNED_TIME_2],this.state?.attributes[vt.ESTIMATED_TIME_2]),this.times[3].updateTime(this.state?.attributes[vt.PLANNED_TIME_3],this.state?.attributes[vt.ESTIMATED_TIME_3]),this.times[4].updateTime(this.state?.attributes[vt.PLANNED_TIME_4],this.state?.attributes[vt.ESTIMATED_TIME_4])}render(){return F`
    ...
    `],t([ct({attribute:!1})],zt.prototype,"config",void 0),t([ct({attribute:!1})],zt.prototype,"state",void 0),t([ct({attribute:!1})],zt.prototype,"showIcon",void 0),t([ct({attribute:!1})],zt.prototype,"timeStyle",void 0),t([ct({attribute:!1})],zt.prototype,"lineColor",void 0),t([ct({attribute:!1})],zt.prototype,"timesToShow",void 0),t([ct({attribute:!1})],zt.prototype,"showAnimation",void 0),t([dt()],zt.prototype,"times",void 0),zt=t([at("departures-row")],zt),window.customCards=window.customCards||[],window.customCards.push({type:"departures-card",name:"Departures Card",description:"Display departure times for different public transports"});console.groupCollapsed("%cDepartures-Card 1.0.0","color:black; font-weight: bold; background: tomato; padding: 2px; border-radius: 5px;"),console.log("Github repository: https://github.com/alex-jung/ha-departures-card"),console.groupEnd();let Ft=class extends rt{constructor(){super(...arguments),this.moreInfoOpen=!1}static getStubConfig(){return{}}async getCardSize(){return this.config&&this.config.entities?this.config.entities.length+1:1}setConfig(t){if(!t)throw new Error("Invalid configuration");if(this.config=t,!this.config.entities||this.config.entities.length<=0)throw new Error("Please define at least one entity in the configuration.")}render(){const t=this.config.title||ut("departures",this.hass.locale?.language),e=this.config.icon||"mdi:bus";return F`
      <ha-card>
