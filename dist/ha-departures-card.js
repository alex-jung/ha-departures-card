 ...
 */}function dt(t){return ct({...t,state:!0,attribute:!1})}const pt=o`
    ...
    `;function ut(t,e){const i={de:{departures:"Abfahrten",line:"Linie",destination:"Ziel"},en:{departures:"Departures",line:"Line",destination:"Destination"}};return e&&"undefined"!==e||(e="en"),i[e][t]||i.en[t]}let ft=class extends rt{constructor(){super(...arguments),this.moreInfo=!1}getState(t){return this.hass?this.hass.states[t]:{}}render(){const t=this.hass.locale?.language,e=void 0===this.config.showAnimation||this.config.showAnimation,i=void 0!==this.config.showTransportIcon&&this.config.showTransportIcon;let s=void 0===this.config.departuresToShow?1:this.config.departuresToShow;if(this.moreInfo&&(s=5),console.log(this.hass.selectedTheme),"object"==typeof this.hass.selectedTheme){const t=this.hass.selectedTheme;void 0!==t.dark&&console.log("dark mode",t.dark)}return F`
            <table-header>
